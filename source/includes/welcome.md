...
This allows the developers to automate the security testing of the application in the CI/CD pipeline. 
...
use ZAP as a proxy, access to the API. The API is configured using the Options API screen.
